...
function loadAdminNotices() {
    ...
    if (marquee) {
        ...
        marquee.innerHTML = notices.length > 0 
            ...
            : "বর্তমানে কোনো অফিশিয়াল নোটিশ নেই।";
...
function renderFullNoticeArchive() {
    ...
    `).join('') : '<p style="color:#64748b;">কোনো অফিশিয়াল নোটিশ পোস্ট করা হয়নি।</p>';
...
let currentPracText = "বাংলা আমাদের মাতৃভাষা। নিয়মিত টাইপিং অনুশীলন করলে আপনার গতি ও নির্ভুলতা বৃদ্ধি পাবে। সরকারি চাকরির পরীক্ষার জন্য ভালোভাবে প্রস্তুতি নিন।";
...
function selectPracMode(mode) {
    ...
    currentPracText = mode === 'en' 
        ...
        : "বাংলা আমাদের মাতৃভাষা। নিয়মিত টাইপিং অনুশীলন করলে আপনার গতি ও নির্ভুলতা বৃদ্ধি পাবে। সরকারি চাকরির পরীক্ষার জন্য ভালোভাবে প্রস্তুতি নিন।";
...
function checkLiveExam() {
    ...
    container.innerHTML = `
        ...
        <div class="prac-controls">
            ...
            <div><b>সময়:</b> ${examData.duration} মিনিট</div>
        ...
        <div class="prac-stats" style="margin-top:15px;">
            ...
            <div>সময় বাকি: <span id="examTimer">00:00</span></div>
...
function submitLiveExam() {
    ...
    alert("✅ পরীক্ষা সফলভাবে সাবমিট হয়েছে!");
...
function checkAndShowResult() {
    ...
    if (!isPublished) {
        ...
        statusMsg.innerHTML = "🔒 ফলাফল এখনো প্রকাশ করা হয়নি। অ্যাডমিন রেজাল্ট প্রকাশ করলে দেখতে পাবেন।";
    ...
    `).join('') : '<tr><td colspan="4" style="text-align:center;">কোনো রেজাল্ট পাওয়া যায়নি।</td></tr>';
...
function loadPackagesPortal() {
    ...
    container.innerHTML = pkgs.length > 0 ? pkgs.map(p => `
        ...
        <div style="border:1px solid #cbd5e1; padding:15px; border-radius:8px; background:#fff; width:250px; box-shadow:0 2px 5px rgba(0,0,0,0.05);">
            ...
            <button onclick="requestPackage('${p.title}', '${p.price}', ${p.days || 30})" style="margin-top:15px; width:100%; padding:9px; background:#2563eb; color:#fff; font-weight:bold; border:none; border-radius:5px; cursor:pointer;">💳 ক্রয় করুন</button>
...
function requestPackage(title, price, days) {
    ...
    if (!trx.trim()) {
        ...
        alert('⚠️ ভুল ট্রানজেকশন আইডি! অনুরোধ বাতিল করা হয়েছে।');
    ...
    alert('✅ আপনার পেমেন্ট অনুরোধ অ্যাডমিনের নিকট পাঠানো হয়েছে! অ্যাডমিন যাচাই করে দ্রুত এপ্রুভ করবেন।');
