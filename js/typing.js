...
        </div>
    `).join('') : '<p style="color:#64748b;">বর্তমানে কোনো সক্রিয় পরীক্ষা নেই। এডমিন সেটআপ করলে এখানে দেখাবে।</p>';
}
...
    } else {
        alert("❌ আইডি বা ফোন নম্বর সঠিক নয়! অনুগ্রহ করে সঠিকভাবে নাম ও তথ্য দিয়ে আইডিটি নিশ্চিত করুন।");
    }
}
